"""
agentbox.seal.fingerprint
=========================
Cryptographic fingerprinting primitives for AgentBox seal.
...
def fingerprint_model(provider: str, name: str, pinned_version: Optional[str] = None,
    ...
    if not probe:
        fp["probe_skipped_reason"] = "probe disabled (run `agentbox seal --probe` to enable)"
        return fp
