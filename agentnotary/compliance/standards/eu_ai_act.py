"""
agentnotary.compliance.standards.eu_ai_act
=======================================
...
def build_document(ctx: ComplianceContext) -> dict:
    ...
    sections.append({
        ...
        "body": (
            "The system is operated under AgentNotary's runtime guard, which intercepts "
    ...
    sections.append({
        ...
        "fields": [
            ...
            ("Cybersecurity controls",
             ...
             "cost-cap circuit breakers via `agentnotary guard`"),
        ],
    })
    ...
    if lock:
        ...
        seal_fields = [("Seal status", "**No agent.lock found. Run `agentnotary seal`.**")]
